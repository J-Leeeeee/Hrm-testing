# Upstream Hierarchical Reasoning Model

This file is the original project README from
[sapientinc/HRM](https://github.com/sapientinc/HRM), preserved for architecture,
training, and dataset documentation. The evaluation study added in this
repository is documented in [README.md](README.md) and [report.md](report.md).

The remainder of this file is the upstream README.
